      ...
      <div style={{ padding: '40px 24px', maxWidth: '1200px', margin: '0 auto' }}>
        <SignedOut>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p className="hero-subtitle">Sign in to access your class AI assistant</p>
          </div>
          ...
          <div className="feature-card" style={{ maxWidth: '500px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: '700', color: '#111827', marginBottom: '12px' }}>Sign in to continue</h2>
            ...
            <form onSubmit={handleCodeSubmit} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
              <div style={{ flex: 1, minWidth: '200px' }}>
                <input
                  type="text"
                  value={teacherCode}
                  onChange={(e) => { setTeacherCode(e.target.value.toUpperCase()); setError('') }}
                  ...
                  onFocus={(e) => { if (!error) { e.target.style.borderColor = '#3B82F6'; e.target.style.boxShadow = '0 0 0 3px rgba(59, 130, 246, 0.1)' } }}
              ...
              <button
                ...
                style={{ opacity: (!teacherCode.trim() || isLoading) ? '0.5' : '1', cursor: (!teacherCode.trim() || isLoading) ? 'not-allowed' : 'pointer', minWidth: '120px' }}
              >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px' }}>
              {classes.map((classItem) => (
                <div key={classItem.code} className="feature-card hover-card" onClick={() => handleClassClick(classItem.code)} style={{ cursor: 'pointer' }}>
                  <div style={{ width: '48px', height: '48px', background: 'linear-gradient(135deg, #3B82F6 0%, #2563EB 100%)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
                  ...
                  <div style={{ padding: '12px', background: '#EFF6FF', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
