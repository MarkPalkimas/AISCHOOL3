        ...
        <SignedIn>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Track student engagement and see what questions are being asked most frequently.
              </p>
              <button className="btn-secondary w-full" disabled>
                Coming Soon
              </button>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    The full teacher dashboard is currently being built. Soon you'll be able to upload materials, 
                    configure your AI assistant, and track student engagement.
                  </p>
                </div>
              </div>
            </div>
